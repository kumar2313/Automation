...
const Cremantsensitivity = (props) => {
    ...
    const detcolumns = [
        ...
        {
            name: 'PREVIOUS_SIZE',
            selector: row => row.PREVIOUS_SIZE,
            wrap: true,
            width: '100px',
            sortable: true,
                                ...
                                {data.map((val, key) => {
                                    return (
                                        <tr key={key}>
                                            ...
                                            <td style={{ backgroundColor: "yellow" }} onClick={() => showdetails(props.statusdet, detcolumns, "FILE", "JOB_ID", "FILE_NAME")}>{val.count}</td>
                                        </tr>
                                    )
                                })}
                                <tr key="Missing">
...
export default Cremantsensitivity
